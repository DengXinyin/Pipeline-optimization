...
def _run_tax_metaseq(tpmdir, datadir, res_dir):
    ...
    cmd = [Rscript_j, os.path.join(scripts_path, r_script), tpmdir, datadir, res_dir]
...
def plot(tpmdir, datadir, res_dir, pre_resdir):
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as executor:
        futures = {
            ...
            executor.submit(_run_tax_metaseq, tpmdir, datadir, res_dir): 'tax_metaseq',
        }
