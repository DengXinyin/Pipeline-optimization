...
FUNC_INDEX = [
    ...
    'ARG', 'VFDB', 'BacMet2', 'mobileOG', 'QS', 'COG', 'MetaCyc'
]
...
def get_resdir(res_dir, group_num, func, test_type):
    if func in ('1.KEGG', '2.eggNOG', '3.CAZy', '4.GO'):
        ...
        return os.path.join(res_dir, group_num, '15-COG', '6.Statistical_test_analysis', test_type)
    elif func == 'MetaCyc':
        return os.path.join(res_dir, group_num, '16-MetaCyc', '6.Statistical_test_analysis', test_type)
    else:
